...
<img src="{{ site.baseurl }}/assets/dehazer/pipeline-flowchart.jpg" style="max-width:600px; width:100%;" alt="Pipeline flowchart">
...
<img src="{{ site.baseurl }}/assets/dehazer/classifier-architecture.jpg" style="max-width:600px; width:100%;" alt="Classifier architecture">
...
<img src="{{ site.baseurl }}/assets/dehazer/ktdn-architecture.jpg" style="max-width:600px; width:100%;" alt="KTDN architecture">
...
<div style="display:flex; gap:8px; flex-wrap:wrap; max-width:600px;">
  <img src="{{ site.baseurl }}/assets/dehazer/student-result-1.jpg" style="width:48%;">
  <img src="{{ site.baseurl }}/assets/dehazer/student-result-2.jpg" style="width:48%;">
</div>
<div style="display:flex; gap:8px; flex-wrap:wrap; max-width:600px;">
  <img src="{{ site.baseurl }}/assets/dehazer/student-result-3.jpg" style="width:48%;">
</div>
